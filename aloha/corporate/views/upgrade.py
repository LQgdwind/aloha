...
from zerver.decorator import require_organization_member, aloha_login_required
...
def upgrade(
    ...
    try:
        ...
        error_message = BillingError.CONTACT_SUPPORT.format(email=settings.aloha_ADMINISTRATOR)

...
class UserBaseSettings(models.Model):
    ...
    notification_sound = models.CharField(max_length=20, default="aloha")
...
class AbstractEmoji(models.Model):
    ...
    on how this subsystem works, see:
      https://aloha.readthedocs.io/en/latest/subsystems/emoji.html
    """
    ...
    aloha_EXTRA_EMOJI = "aloha_extra_emoji"
    REACTION_TYPES = (
        (UNICODE_EMOJI, gettext_lazy("Unicode emoji")),
        (REALM_EMOJI, gettext_lazy("Custom emoji")),
        (aloha_EXTRA_EMOJI, gettext_lazy("Aloha extra emoji")),
    )
    ...
    #
    # * For "Aloha extra emoji" (like :aloha:), the name of the emoji (e.g. "aloha").
...
# https://aloha.readthedocs.io/en/latest/subsystems/sending-messages.html#soft-deactivation
#
...
class UserPresence(models.Model):
    ...
    This is a tricky subsystem, because it is highly optimized.  See the docs:
      https://aloha.readthedocs.io/en/latest/subsystems/presence.html
    """
...
class Service(models.Model):
    ...
    # Valid interfaces are {generic, aloha_bot_service, slack}
    GENERIC = 1
    SLACK = 2

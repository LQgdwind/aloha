...
def aloha_default_context(request: HttpRequest) -> Dict[str, Any]:
    ...
    if settings.DEVELOPMENT:
        ...
        secrets_path = "/etc/aloha/aloha-secrets.conf"
        settings_path = "/etc/aloha/settings.py"
        settings_comments_path = "/etc/aloha/settings.py"

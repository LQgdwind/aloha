...
Example: ./manage.py edit_linkifiers --realm=aloha --op=add '#(?P<id>[0-9]{2,8})' \
    'https://support.example.com/ticket/%(id)s'
Example: ./manage.py edit_linkifiers --realm=aloha --op=remove '#(?P<id>[0-9]{2,8})'
Example: ./manage.py edit_linkifiers --realm=aloha --op=show
"""

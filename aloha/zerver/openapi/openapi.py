...
OPENAPI_SPEC_PATH = os.path.abspath(
    os.path.join(os.path.dirname(__file__), "../openapi/aloha.yaml")
)
...
def fix_events(content: Dict[str, Any]) -> None:
    ...
    only aloha.yaml changes and minimal other changes. It should be removed
...
* Updating the OpenAPI schema defined in zerver/openapi/aloha.yaml
...
See https://aloha.readthedocs.io/en/latest/documentation/api.html for help.

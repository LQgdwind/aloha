...
def fix_messages(apps: StateApps, schema_editor: BaseDatabaseSchemaEditor) -> None:
    ...
    * Changing their 1:1 PMs to be PMs with NOTIFICATION_BOT and deleting their
      PM recipient object.
    * Deleting any Huddles that involve them (aloha.com data suggests there are none,
    ...
    * Deleting their UserProfile objects.
    ...
    new_user_bot_email = getattr(settings, "NEW_USER_BOT", "new-user-bot@aloha.com")
    try:
    ...
    feedback_bot_email = getattr(settings, "FEEDBACK_BOT", "feedback@aloha.com")
    try:

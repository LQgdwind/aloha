...
aloha_URL_PREVIEW_USER_AGENT = (
    "Mozilla/5.0 (compatible; AlohaURLPreview/{version}; +{external_host})"
).format(version=aloha_VERSION, external_host=settings.ROOT_DOMAIN_URI)

# FIXME: This header and timeout are not used by pyoembed, when trying to autodiscover!
HEADERS = {"User-Agent": aloha_URL_PREVIEW_USER_AGENT}
TIMEOUT = 15

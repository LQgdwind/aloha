...
"""
    ...
    def validate_api_response_openapi(
        ...
        declared in zerver/openapi/aloha.yaml.  This powerful test lets us use Aloha's
    ...
    example_user_map = dict(
        hamlet="hamlet@aloha.com",
        cordelia="cordelia@aloha.com",
        iago="iago@aloha.com",
        prospero="prospero@aloha.com",
        othello="othello@aloha.com",
        AARON="AARON@aloha.com",
        aaron="aaron@aloha.com",
        ZOE="ZOE@aloha.com",
        polonius="polonius@aloha.com",
        desdemona="desdemona@aloha.com",
        shiva="shiva@aloha.com",
        webhook_bot="webhook-bot@aloha.com",
        welcome_bot="welcome-bot@aloha.com",
        outgoing_webhook_bot="outgoing-webhook@aloha.com",
        default_bot="default-bot@aloha.com",
    )
    ...
    nonreg_user_map = dict(
        test="test@aloha.com",
        test1="test1@aloha.com",
        alice="alice@aloha.com",
        newuser="newuser@aloha.com",
        bob="bob@aloha.com",
        cordelia="cordelia@aloha.com",
        newguy="newguy@aloha.com",
        me="me@aloha.com",
    )
    ...
    def nonreg_user(self, name: str) -> UserProfile:
        ...
        return get_user_by_delivery_email(email, get_realm("aloha"))
    ...
    def create_test_bot(
        ...
        bot_email = f"{short_name}-bot@aloha.testserver"
    ...
    def encode_email(self, email: str, realm: str = "aloha") -> str:
...
{self.subscribed_stream_name_list(sender)}
    ...
    def change_ldap_user_attr(
        ...
        """
        dn = f"uid={username},ou=users,dc=aloha,dc=com"
        if binary:
...
class WebhookTestCase(AlohaTestCase):
    ...
    * Tests should specify WEBHOOK_DIR_NAME to enforce that all event
    ...
    TEST_USER_EMAIL = "webhook-bot@aloha.com"
    URL_TEMPLATE: str
    ...
    def test_user(self) -> UserProfile:
        return get_user(self.TEST_USER_EMAIL, get_realm("aloha"))
...
class MigrationsTestCase(AlohaTestCase):  # nocoverage
    ...
    Documented at https://aloha.readthedocs.io/en/latest/subsystems/schema-migrations.html
    """

...
class BotIntegration(Integration):
    ...
    aloha_LOGO_STATIC_PATH_PNG = "images/logo/aloha-icon-128x128.png"
    ...
    def __init__(
        ...
        if logo is None:
            ...
            if self.logo_url is None:
                ...
                logo = staticfiles_storage.url(self.aloha_LOGO_STATIC_PATH_PNG)  # nocoverage
        else:
...
DOC_SCREENSHOT_CONFIG: Dict[str, List[BaseScreenshotConfig]] = {
    ...
    "dialogflow": [ScreenshotConfig("weather_app.json", extra_params={"email": "iago@aloha.com"})],

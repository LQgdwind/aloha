...
logger = logging.getLogger("aloha.send_email")
log_to_file(logger, settings.EMAIL_LOG_PATH)


class FromAddress:
    SUPPORT = parseaddr(settings.aloha_ADMINISTRATOR)[1]
...
def build_email(
    ...
    # https://aloha.readthedocs.io/en/latest/translating/internationalization.html

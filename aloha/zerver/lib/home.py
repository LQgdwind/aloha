...
def promote_sponsoring_aloha_in_realm(realm: Realm) -> bool:
    if not settings.PROMOTE_SPONSORING_aloha:
        return False

    # If PROMOTE_SPONSORING_aloha is enabled, advertise sponsoring
...
def build_page_params_for_home_page_load(
    ...
    page_params: Dict[str, object] = dict(
        ...
        promote_sponsoring_aloha=promote_sponsoring_aloha_in_realm(realm),

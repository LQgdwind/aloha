...
def destroy_test_databases(worker_id: Optional[int] = None) -> None:
    for alias in connections:
        ...
        try:
            ...
            # template database name (aloha_test_template).  So to
            # delete the database aloha_test_template_<number>, we
            ...
            # updated to have `aloha_test_template_<number>` as its
...
class Runner(DiscoverRunner):
    ...
    def teardown_test_environment(self, *args: Any, **kwargs: Any) -> Any:
        # The test environment setup clones the aloha_test_template
        # database, creating databases with names:
        #     'aloha_test_template_N_<worker_id>',

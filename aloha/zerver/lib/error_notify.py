...
def notify_browser_error(report: Dict[str, Any]) -> None:
    ...
    if settings.ERROR_BOT:
        aloha_browser_error(report, settings.ERROR_BOT)
...
def aloha_browser_error(report: Dict[str, Any], error_bot_email: str) -> None:
...
def notify_server_error(report: Dict[str, Any]) -> None:
    ...
    if settings.ERROR_BOT:
        aloha_server_error(report, settings.ERROR_BOT)


def aloha_server_error(report: Dict[str, Any], error_bot_email: str) -> None:

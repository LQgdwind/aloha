...
def do_send_missedmessage_events_reply_in_aloha(
...
def handle_missedmessage_emails(
    ...
    for bucket_tup, ignored_max_id in bucket_tups:
        ...
        do_send_missedmessage_events_reply_in_aloha(
            user_profile,
...
def enqueue_welcome_emails(user: UserProfile, realm_creation: bool = False) -> None:
    ...
    if user.is_realm_admin:
        context["getting_started_link"] = (
            user.realm.uri + "/help/getting-your-organization-started-with-aloha"
        )
    else:
        context["getting_started_link"] = "https://aloha.com"

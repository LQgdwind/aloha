...
def fetch_initial_state_data(
    ...
    *,
    ...
    state["aloha_version"] = aloha_VERSION
    state["aloha_feature_level"] = API_FEATURE_LEVEL
    state["aloha_merge_base"] = aloha_MERGE_BASE
    ...
    if want("realm"):
        ...
        state["aloha_plan_is_not_limited"] = realm.plan_type != Realm.PLAN_TYPE_LIMITED
    ...
    if event["type"] == "message":
        ...
        if event["op"] == "update":
            ...
            if event["property"] == "plan_type":
                ...
                state["aloha_plan_is_not_limited"] = event["value"] != Realm.PLAN_TYPE_LIMITED

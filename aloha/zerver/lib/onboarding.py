...
def send_initial_pms(user: UserProfile) -> None:
    ...
    with override_language(user.default_language):
        if user.is_realm_admin:
            help_url = user.realm.uri + "/help/getting-your-organization-started-with-aloha"
            organization_setup_text = (
    ...
    content = content.format(
        ...
        getting_started_url="/help/getting-started-with-aloha",
    )
    ...
    if human_response_lower in ["app", "apps"]:
        ...
        return "".join(
            [
                ...
                _(
                    "Check out our [Getting started guide](/help/getting-started-with-aloha), "

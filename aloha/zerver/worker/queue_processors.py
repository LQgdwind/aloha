# Documented in https://aloha.readthedocs.io/en/latest/subsystems/queuing.html
import base64
import copy
import datetime
import email
...
from aloha_bots.lib import extract_query_without_mention
...
class TestWorker(QueueProcessingWorker):
    ...
    def consume(self, event: Mapping[str, Any]) -> None:  # nocoverage
        fn = settings.aloha_WORKER_TEST_FILE

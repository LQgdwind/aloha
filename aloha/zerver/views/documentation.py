...
from zerver.context_processors import aloha_default_context
...
def add_api_uri_context(context: Dict[str, Any], request: HttpRequest) -> None:
    context.update(aloha_default_context(request))

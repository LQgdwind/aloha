...
from zerver.decorator import aloha_login_required
...
def get_bigbluebutton_url(
    ...
    id = "aloha-" + str(random.randint(100000000000, 999999999999))
...
# We use aloha_login_required here mainly to get access to the user's

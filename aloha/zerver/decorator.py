...
webhook_logger = logging.getLogger("aloha.zerver.webhooks")
webhook_unsupported_events_logger = logging.getLogger("aloha.zerver.webhooks.unsupported")
webhook_anomalous_payloads_logger = logging.getLogger("aloha.zerver.webhooks.anomalous")
...
def user_passes_test(
    ...
    def decorator(
        ...
        def _wrapped_view(
            ...
            return aloha_redirect_to_login(request, login_url, redirect_field_name)
...
def web_public_view(
    ...
    """
    actual_decorator = lambda view_func: aloha_otp_required_if_logged_in(
...
def aloha_otp_required_if_logged_in(

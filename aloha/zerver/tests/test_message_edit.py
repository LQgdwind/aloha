...
class EditMessageTest(EditMessageTestCase):
    ...
    def test_edit_link(self) -> None:
        ...
        msg_id_1 = self.send_stream_message(
            ...
            "Denmark",
            topic_name="editing",
            content="Here is a link to [aloha](www.aloha.org).",
        )
        new_content_1 = "Here is a link to [aloha](www.alohachat.com)."
        result_1 = self.client_patch(
            f"/json/messages/{msg_id_1}",
            {
                "content": new_content_1,
        ...
        self.assertEqual(
            ...
            "<p>Here is a link to " '<a href="http://www.aloha.org">aloha</a>.</p>',
        )
        self.assertEqual(
            message_history_1[1]["rendered_content"],
            "<p>Here is a link to " '<a href="http://www.alohachat.com">aloha</a>.</p>',
        )
        self.assertEqual(
            message_history_1[1]["content_html_diff"],
            (
                '<div><p>Here is a link to <a href="http://www.alohachat.com"'
                ">aloha "
                '<span class="highlight_text_inserted"> Link: http://www.alohachat.com .'
                '</span> <span class="highlight_text_deleted"> Link: http://www.aloha.org .'
                "</span> </a></p></div>"
            ),
        )

...
class AdminNotifyHandlerTest(AlohaTestCase):
    ...
    def get_admin_aloha_handler(self) -> AdminNotifyHandler:
    ...
    def test_basic(self, mock_function: MagicMock) -> None:
        ...
        handler = self.get_admin_aloha_handler()
        try:
    ...
    def test_request(self, mock_function: MagicMock) -> None:
        ...
        self.assertIn("message", report)
        self.assertEqual(report["stack_trace"], "See /var/log/aloha/errors.log")
...
class RateLimitFilterTest(AlohaTestCase):
    ...
    logger = logging.getLogger("aloha.test_aloha_admins_handler")

...
class MatterMostImporter(AlohaTestCase):
    ...
    def test_process_user(self) -> None:
        ...
        self.assertEqual(user["delivery_email"], "harry@aloha.com")
        self.assertEqual(user["email"], "harry@aloha.com")
        ...
        self.assertEqual(user["avatar_source"], "G")
        self.assertEqual(user["delivery_email"], "snape@aloha.com")
        self.assertEqual(user["email"], "snape@aloha.com")
    ...
    def test_process_message_attachments(self) -> None:
        ...
        self.assertEqual(
            user_handler.get_user(zerver_attachments[0]["owner"])["email"], "ron@aloha.com"
        )
        ...
        self.assertEqual(uploads_list[0]["user_profile_email"], "ron@aloha.com")
    ...
    def test_do_convert_data(self) -> None:
        ...
        self.assertEqual(
            {"harry@aloha.com", "ron@aloha.com", "snape@aloha.com"}, exported_user_emails
        )
        ...
        self.assertFalse(get_user("harry@aloha.com", realm).is_mirror_dummy)
        self.assertFalse(get_user("ron@aloha.com", realm).is_mirror_dummy)
        self.assertTrue(get_user("snape@aloha.com", realm).is_mirror_dummy)
    ...
    def test_do_convert_data_with_direct_messages(self) -> None:
        ...
        exported_user_emails = self.get_set(realm["zerver_userprofile"], "email")
        self.assertEqual(
            {"harry@aloha.com", "ron@aloha.com", "ginny@aloha.com", "voldemort@aloha.com"},
        ...
        self.assertEqual(stream_messages[0].sender.email, "ron@aloha.com")
        self.assertEqual(stream_messages[0].content, "ron joined the channel.\n\n")

        self.assertEqual(stream_messages[3].sender.email, "harry@aloha.com")
        self.assertRegex(
        ...
        self.assertEqual(huddle_messages[0].sender.email, "ginny@aloha.com")
        ...
        self.assertEqual(personal_messages[0].sender.email, "ron@aloha.com")

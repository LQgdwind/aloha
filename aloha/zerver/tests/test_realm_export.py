...
class RealmExportTest(AlohaTestCase):
    ...
    def test_endpoint_s3(self) -> None:
        ...
        self.assertIn("/tmp/aloha-export-", args["output_dir"])
        ...
        self.assertEqual(bucket.Object(path_id).get()["Body"].read(), b"aloha!")
    ...
    def test_upload_and_message_limit(self) -> None:
        ...
        self.assert_json_error(
            result,
            f"Please request a manual export from {settings.aloha_ADMINISTRATOR}.",
        )

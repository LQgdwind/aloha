...
class TransferUploadsToS3Test(AlohaTestCase):
    ...
    def test_transfer_message_files(self) -> None:
        ...
        upload_message_file("dummy1.txt", len(b"aloha1!"), "text/plain", b"aloha1!", hamlet)
        upload_message_file("dummy2.txt", len(b"aloha2!"), "text/plain", b"aloha2!", othello)
        ...
        self.assertEqual(bucket.Object(attachments[0].path_id).get()["Body"].read(), b"aloha1!")
        self.assertEqual(bucket.Object(attachments[1].path_id).get()["Body"].read(), b"aloha2!")

...
class RealmDomainTest(AlohaTestCase):
    ...
    def test_list_realm_domains(self) -> None:
        ...
        expected = [
            {"domain": "aloha.com", "allow_subdomains": False},
    ...
    def test_delete_all_realm_domains(self) -> None:
        ...
        self.assertFalse(get_realm("aloha").emails_restricted_to_domains)
    ...
    def test_realm_realm_domains_uniqueness(self) -> None:
        ...
        with self.assertRaises(IntegrityError):
            RealmDomain.objects.create(realm=realm, domain="aloha.com", allow_subdomains=True)

...
class TestGenericOutgoingWebhookService(AlohaTestCase):
    def setUp(self) -> None:
        ...
        self.bot_user = get_user("outgoing-webhook@aloha.com", get_realm("aloha"))
    ...
    def test_make_request(self) -> None:
        ...
        validate_against_openapi_schema(request_data, "/aloha-outgoing-webhook", "post", "200")
...
class TestSlackOutgoingWebhookService(AlohaTestCase):
    def setUp(self) -> None:
        ...
        self.stream_message_event = {
            ...
            "message": {
                ...
                "type": "stream",
                "sender_realm_str": "aloha",
                "sender_email": "sampleuser@aloha.com",
                "stream_id": "123",
        ...
        self.private_message_event = {
            ...
            "message": {
                ...
                "sender_email": "cordelia@aloha.com",
                "type": "private",
                "sender_realm_id": 1,
                "id": 219,
                TOPIC_NAME: "test",
    ...
    def test_make_request_stream_message(self) -> None:
        ...
        self.assertEqual(request_data[2][1], "aloha.testserver")  # team_domain

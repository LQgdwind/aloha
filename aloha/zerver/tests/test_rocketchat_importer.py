...
class RocketChatImporter(AlohaTestCase):
    ...
    def test_process_users(self) -> None:
        ...
        self.assertEqual(user["delivery_email"], "rocket.cat-bot@aloha.com")
        self.assertEqual(user["email"], "rocket.cat-bot@aloha.com")
    ...
    def test_write_emoticon_data(self) -> None:
        ...
        self.assertEqual(zerver_realmemoji[2]["name"], "aloha")
        self.assertEqual(zerver_realmemoji[2]["file_name"], "aloha.png")
        ...
        self.assertEqual(records_json[2]["name"], "aloha")
        self.assertEqual(records_json[2]["file_name"], "aloha.png")
    ...
    def test_do_convert_data(self) -> None:
        ...
        with self.assertLogs(level="INFO") as info_log, self.settings(
            EXTERNAL_HOST="aloha.example.com"
        ):
        ...
        self.assertEqual(
            ...
            {
                "rocket.cat-bot@aloha.example.com",
        ...
        self.assertFalse(get_user("rocket.cat-bot@aloha.example.com", realm).is_mirror_dummy)
        self.assertTrue(get_user("rocket.cat-bot@aloha.example.com", realm).is_bot)

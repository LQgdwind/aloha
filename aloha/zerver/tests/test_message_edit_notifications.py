...
class EditMessageSideEffectsTest(AlohaTestCase):
    ...
    def _send_and_update_message(
        ...
        if connected_to_aloha:
            with self._cordelia_connected_to_aloha():
    ...
    def _cordelia_connected_to_aloha(self) -> Any:
        """
        ...
        """
        return mock.patch(
            "zerver.tornado.event_queue.receiver_is_off_aloha",
            return_value=False,
        )
    ...
    def test_stream_push_notify_for_sorta_present_user(self) -> None:
        ...
        self._send_and_update_message(
            original_content, updated_content, expect_short_circuit=True, connected_to_aloha=True
        )

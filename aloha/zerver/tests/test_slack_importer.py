...
class SlackImporter(AlohaTestCase):
    ...
    def test_users_to_zerver_userprofile(self, mock_get_data_file: mock.Mock) -> None:
        ...
        # and hence has aloha_id = 1
        test_slack_user_id_to_aloha_user_id = {
            "U08RGD1RD": 1,
            "U0CBK5KAT": 0,
            "U09TYF5Sk": 2,
            "UHSG7OPQN": 3,
        ...
        self.assertDictEqual(slack_user_id_to_aloha_user_id, test_slack_user_id_to_aloha_user_id)
        ...
        self.assertEqual(
            zerver_userprofile[1]["id"], test_slack_user_id_to_aloha_user_id["U0CBK5KAT"]
        )
        ...
        self.assertEqual(
            zerver_userprofile[2]["id"], test_slack_user_id_to_aloha_user_id["U09TYF5Sk"]
        )
        ...
        self.assertEqual(zerver_userprofile[2]["email"], "bot1@alohachat.com")
        self.assertEqual(zerver_userprofile[2]["bot_type"], 1)
        self.assertEqual(zerver_userprofile[2]["avatar_source"], "U")

        self.assertEqual(
            zerver_userprofile[3]["id"], test_slack_user_id_to_aloha_user_id["UHSG7OPQN"]
        )
        ...
        self.assertEqual(
            zerver_userprofile[4]["id"], test_slack_user_id_to_aloha_user_id["U8VAHEVUY"]
        )
        ...
        self.assertEqual(
            zerver_userprofile[5]["id"], test_slack_user_id_to_aloha_user_id["U8X25EBAB"]
        )
        ...
        self.assertEqual(
            zerver_userprofile[6]["id"], test_slack_user_id_to_aloha_user_id["U015J7JSE"]
        )
        ...
        self.assertEqual(
            zerver_userprofile[7]["id"], test_slack_user_id_to_aloha_user_id["U1RDFEC80"]
        )
    ...
    def test_build_pm_recipient_sub_from_user(self) -> None:
        ...
        recipient_id = 5
        subscription_id = 7
        sub = build_subscription(recipient_id, aloha_user_id, subscription_id)
        recipient = build_recipient(aloha_user_id, recipient_id, Recipient.PERSONAL)
    ...
    def test_build_subscription(self) -> None:
        ...
        self.assertEqual(
            ...
            slack_user_id_to_aloha_user_id[channel_members[0]],
        )
        self.assertEqual(
            zerver_subscription[2]["user_profile"],
            slack_user_id_to_aloha_user_id[channel_members[2]],
        )
    ...
    def test_channels_to_zerver_stream(self) -> None:
        ...
        slack_recipient_names = (
            set(slack_user_id_to_aloha_user_id.keys())
        ...
        # recipients, slack_user_id_to_aloha_user_id are iterated in different order in Python 3.5 and 3.6.
        self.assertEqual(
            set(slack_recipient_name_to_aloha_recipient_id.keys()), slack_recipient_names
        )
        self.assertEqual(set(slack_recipient_name_to_aloha_recipient_id.values()), set(range(11)))
    ...
    def test_slack_workspace_to_realm(
        ...
        self.assertEqual(slack_user_id_to_aloha_user_id, {})
        self.assertEqual(added_channels, {})
        self.assertEqual(added_mpims, {})
        self.assertEqual(slack_recipient_name_to_aloha_recipient_id, {})
    ...
    def test_channel_message_to_zerver_message(self, mock_build_usermessage: mock.Mock) -> None:
        ...
        slack_user_id_to_aloha_user_id = {"U066MTL5U": 5, "U061A5N1G": 24, "U061A1R2R": 43}
        ...
        self.assertEqual(
            zerver_message[4]["recipient"], slack_recipient_name_to_aloha_recipient_id["general"]
        )
        self.assertEqual(zerver_message[2][EXPORT_TOPIC_NAME], "imported from Slack")
        self.assertEqual(
            zerver_message[1]["recipient"], slack_recipient_name_to_aloha_recipient_id["random"]
        )
        self.assertEqual(
            zerver_message[5]["recipient"],
            slack_recipient_name_to_aloha_recipient_id["mpdm-user9--user2--user10-1"],
        )
        self.assertEqual(
            zerver_message[6]["recipient"],
            slack_recipient_name_to_aloha_recipient_id["mpdm-user6--user7--user4-1"],
        )
        self.assertEqual(
            zerver_message[7]["recipient"], slack_recipient_name_to_aloha_recipient_id["U061A5N1G"]
        )
        self.assertEqual(
            zerver_message[7]["recipient"], slack_recipient_name_to_aloha_recipient_id["U061A5N1G"]
        )
    ...
    def test_slack_import_to_existing_database(
        ...
        with self.assertLogs(level="INFO"), self.settings(EXTERNAL_HOST="aloha.example.com"):

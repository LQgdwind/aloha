...
class TestBasicUserStuff(AlohaTestCase):
    ...
    def test_users(self) -> None:
        ...
        self.assertEqual(self.example_email("cordelia"), "cordelia@aloha.com")
...
class TestFullStack(AlohaTestCase):
    ...
    #
    # See https://aloha.readthedocs.io/en/latest/testing/philosophy.html
    ...
    def test_client_post(self) -> None:
        ...
        self.assertRaises(
            UserProfile.DoesNotExist, lambda: get_user_by_delivery_email("romeo@aloha.net", realm)
        )
        ...
        romeo = get_user_by_delivery_email("romeo@aloha.net", realm)
    ...
    def test_can_create_users(self) -> None:
        ...
        #
        # See https://aloha.readthedocs.io/en/latest/testing/philosophy.html#share-test-setup-code.
        iago = self.example_user("iago")
        self.login_user(iago)
        ...
        result = self.client_post("/json/users", valid_params)
        self.assert_json_error(result, "Email 'romeo@aloha.net' already in use", 400)

    def test_tornado_redirects(self) -> None:
        # Let's poke a bit at Aloha's event system.
        # See https://aloha.readthedocs.io/en/latest/subsystems/events-system.html
...
class TestDevelopmentEmailsLog(AlohaTestCase):
    ...
    # all sorts of emails aloha sends. Those can be accessed at /emails/

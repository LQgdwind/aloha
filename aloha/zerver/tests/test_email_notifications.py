...
class TestCustomEmails(AlohaTestCase):
    ...
    def test_send_custom_email_remote_server(self) -> None:
        ...
        reply_to = "reply_to_test"
        from_name = "from_name_test"
        contact_email = "aloha-admin@example.com"
...
class TestFollowupEmails(AlohaTestCase):
    def test_day1_email_context(self) -> None:
        ...
        self.assertEqual(email_data["context"]["getting_started_link"], "https://aloha.com")
        ...
        self.assertEqual(
            ...
            "http://aloha.testserver/help/getting-your-organization-started-with-aloha",
        )
        self.assertNotIn("ldap_username", email_data["context"])

    # See https://aloha.readthedocs.io/en/latest/production/authentication-methods.html#ldap-including-active-directory
    # for case details.
    @override_settings(
    ...
    def test_day1_email_ldap_case_a_login_credentials(self) -> None:
        ...
        with self.settings(AUTH_LDAP_USER_ATTR_MAP=ldap_user_attr_map):
            self.login_with_return(
                ...
                self.ldap_password("newuser_email_as_uid@aloha.com"),
            )
            user = UserProfile.objects.get(delivery_email="newuser_email_as_uid@aloha.com")
            ...
            self.assertEqual(
                email_data["context"]["ldap_username"], "newuser_email_as_uid@aloha.com"
            )
    ...
    def test_day1_email_ldap_case_b_login_credentials(self) -> None:
        ...
        with self.settings(
            ...
            self.login_with_return("newuser@aloha.com", self.ldap_password("newuser"))

            user = UserProfile.objects.get(delivery_email="newuser@aloha.com")
            scheduled_emails = ScheduledEmail.objects.filter(users=user)
    ...
    def test_day1_email_ldap_case_c_login_credentials(self) -> None:
        ...
        with self.settings(
            ...
            user = UserProfile.objects.get(delivery_email="newuser_email@aloha.com")
            scheduled_emails = ScheduledEmail.objects.filter(users=user)
...
class TestMissedMessages(AlohaTestCase):
    def test_read_message(self) -> None:
        ...
        with mock.patch(
            "zerver.lib.email_notifications.do_send_missedmessage_events_reply_in_aloha"
        ) as m:
            handle_missedmessage_emails(
    ...
    def _test_cases(
        ...
        self.assertEqual(msg.extra_headers["List-Id"], "Aloha Dev <aloha.testserver>")
    ...
    def _extra_context_in_missed_stream_messages_mention(
        ...
        if show_message_content:
            ...
            verify_body_include = [
                ...
                "http://aloha.testserver/help/pm-mention-alert-notifications ",
                "View or reply in Aloha Dev Aloha",
                " Manage email preferences: http://aloha.testserver/#settings/notifications",
            ]
        ...
        if show_message_content:
            ...
            if message_content_disabled_by_realm:
                verify_body_include = [
                    ...
                    "http://aloha.testserver/help/hide-message-content-in-emails",
                    "View or reply in Aloha Dev Aloha",
                    " Manage email preferences: http://aloha.testserver/#settings/notifications",
                ]
    ...
    def test_smaller_user_group_mention_priority(self) -> None:
        ...
        hamlet_only = create_user_group("hamlet_only", [hamlet], get_realm("aloha"))
        hamlet_and_cordelia = create_user_group(
            "hamlet_and_cordelia", [hamlet, cordelia], get_realm("aloha")
        )
    ...
    def test_realm_emoji_in_missed_message(self) -> None:
        ...
        realm_emoji_url = (
            f"http://aloha.testserver/user_avatars/{realm.id}/emoji/images/{realm_emoji_id}.png"
        )
        verify_body_include = [
    ...
    def test_emojiset_in_missed_message(self) -> None:
        ...
        verify_body_include = [
            '<img alt=":hamburger:" src="http://aloha.testserver/static/generated/emoji/images-twitter-64/1f354.png" title="hamburger" style="height: 20px;">'
        ]
        email_subject = "PMs with Othello, the Moor of Venice"
        self._test_cases(
            msg_id, verify_body_include, email_subject, send_as_user=False, verify_html_body=True
    ...
    def test_stream_link_in_missed_message(self) -> None:
        ...
        stream_id = get_stream("Verona", get_realm("aloha")).id
        href = f"http://aloha.testserver/#narrow/stream/{stream_id}-Verona"
        verify_body_include = [
    ...
    def test_relative_to_full_url(self) -> None:
        ...
        test_data = test_data.format(realm_id=aloha_realm.id)
        actual_output = convert(test_data)
        expected_output = (
        ...
        expected_output = expected_output.format(realm_id=aloha_realm.id)
        self.assertEqual(actual_output, expected_output)
    ...
    def test_long_term_idle_user_missed_message(self) -> None:
        ...
        large_user_group = create_user_group(
            "large_user_group", [hamlet, othello, cordelia], get_realm("aloha")
        )

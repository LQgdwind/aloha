...
def guess_aloha_user_from_harbor(harbor_username: str, realm: Realm) -> Optional[UserProfile]:
    try:
...
def api_harbor_webhook(
    ...
    if operator_username != "auto":
        operator_profile = guess_aloha_user_from_harbor(operator_username, user_profile.realm)

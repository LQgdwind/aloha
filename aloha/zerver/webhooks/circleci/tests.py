...
""".strip()
    ...
    def test_for_failed_build_off_github(self) -> None:
        expected_topic = "aloha"
        expected_message = """
Build [#1429](https://circleci.com/gh/Hypro999/aloha/1429) of `bionic-backend-frontend`/`Ubuntu 18.04 Bionic (Python 3.6, backend+frontend)` on branch `circleci` has failed.
- **Commits (2):** [73900eeb69 ... 5326f9ea40](https://github.com/Hypro999/aloha/compare/73900eeb69adbf0b83dc487e8eda90661b524eff...5326f9ea4084a01cc2bf1a461b9ad819b4ffdd14)
...
""".strip()
    ...
    def test_for_success_build_off_github_with_multiple_parties(self) -> None:
        expected_topic = "aloha"
        expected_message = """
Build [#1431](https://circleci.com/gh/Hypro999/aloha/1431) of `bionic-production-build`/`Production` on branch `circleci` has succeeded.
- **Commits (2):** [73900eeb69 ... 5326f9ea40](https://github.com/Hypro999/aloha/compare/73900eeb69adbf0b83dc487e8eda90661b524eff...5326f9ea4084a01cc2bf1a461b9ad819b4ffdd14)
...
""".strip()
    ...
    def test_for_cancelled_build_off_github(self) -> None:
        expected_topic = "aloha"
        expected_message = """
Build [#1420](https://circleci.com/gh/Hypro999/aloha/1420) of `bionic-production-install`/`Production` on branch `circleci` was canceled.
- **Commit:** [b0d6197fb4](https://github.com/Hypro999/aloha/commit/b0d6197fb4cacaf917adca77f77354882ee80621)
...
""".strip()
    ...
    def test_super_minimal_payload(self) -> None:
        expected_topic = "aloha"
        expected_message = "[Build](https://circleci.com/gh/aloha/aloha/48056) triggered by timabbott on branch `master` has failed."

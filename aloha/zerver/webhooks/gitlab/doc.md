Receive GitLab notifications in Aloha!

1. {!create-stream.md!}

1. {!create-bot-construct-url.md!}

    By default, the Aloha topics for merge requests will contain the
...
!!! tip ""
    ...
    If your GitLab server and your Aloha server are on a local network

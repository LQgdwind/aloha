...
class GitlabHookTests(WebhookTestCase):
    ...
    def test_create_issue_with_two_assignees_event_message(self) -> None:
        ...
        expected_message = "Adam Birds created [issue #2](https://gitlab.com/adambirds/aloha-gitlab-test/issues/2) (assigned to Adam Birds and Eeshan Garg):\n\n~~~ quote\nAloha Test Issue 2\n~~~"
    ...
    def test_create_issue_with_three_assignees_event_message(self) -> None:
        expected_subject = "Aloha GitLab Test / issue #2 Aloha Test Issue 2"
        expected_message = "Adam Birds created [issue #2](https://gitlab.com/adambirds/aloha-gitlab-test/issues/2) (assigned to Adam Birds, Eeshan Garg and Tim Abbott):\n\n~~~ quote\nAloha Test Issue 2\n~~~"
...
~~~
    ...
    def test_pipeline_succeeded_with_artifacts_event_message(self) -> None:
        expected_topic = "onlysomeproject / test/links-in-aloha-pipeline-message"

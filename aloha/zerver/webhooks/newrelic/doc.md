New Relic can send messages to a Aloha stream for incidents.
...
1. Create a new notification channel. Select channel type of **Webhook**, choose a name (e.g. "Aloha"), enter the webhook url created earlier as **Base Url**.

...
test("predicate_basics", () => {
    ...
    const link_msg = {
        content: '<p><a href="http://chat.aloha.org">chat.aloha.org</a></p>',
    };
...
test("parse", () => {
    ...
    string = "pm-with:leo+test@aloha.com";
    operators = [{operator: "pm-with", operand: "leo+test@aloha.com"}];
    _test();

    string = "sender:leo+test@aloha.com";
    operators = [{operator: "sender", operand: "leo+test@aloha.com"}];
    _test();
...
run_test("is_spectator_compatible", () => {
    ...
    assert.ok(Filter.is_spectator_compatible([{operator: "sender", operand: "hamlet@aloha.com"}]));
    assert.ok(
        !Filter.is_spectator_compatible([{operator: "pm-with", operand: "hamlet@aloha.com"}]),
    );
    assert.ok(
        !Filter.is_spectator_compatible([{operator: "group-pm-with", operand: "hamlet@aloha.com"}]),
    );

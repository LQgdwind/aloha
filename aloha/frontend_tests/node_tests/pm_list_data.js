...
const cardelio = {
    email: "cardelio@aloha.com",
    user_id: 105,
    full_name: "Cardelio",
};
const shiv = {
    email: "shiv@aloha.com",
    user_id: 106,
    full_name: "Shiv",
};
const desdemona = {
    email: "desdemona@aloha.com",
    user_id: 107,
    full_name: "Desdemona",
};
const lago = {
    email: "lago@aloha.com",
    user_id: 108,
    full_name: "Lago",
};
const aaron = {
    email: "aaron@aloha.com",
    user_id: 109,
    full_name: "Aaron",
};
const jai = {
...
test("get_active_user_ids_string", () => {
    ...
    set_filter_result(["bob@aloha.com,alice@aloha.com"]);
...
test("get_list_info", ({override}) => {
    ...
    set_filter_result(["alice@aloha.com,bob@aloha.com"]);
    list_info = get_list_info(false);
    ...
    set_filter_result(["alice@aloha.com"]);

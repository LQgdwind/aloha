...
run_test("build_display_recipient", () => {
    ...
    message = {
        type: "private",
        private_message_recipient: "cordelia@aloha.com,hamlet@aloha.com",
        sender_email: "iago@aloha.com",
        sender_full_name: "Iago",
        sender_id: 123,
    };
    ...
    let iago = display_recipient.find((recipient) => recipient.email === "iago@aloha.com");
    assert.equal(iago.full_name, "Iago");
    assert.equal(iago.id, 123);

    const cordelia = display_recipient.find(
        (recipient) => recipient.email === "cordelia@aloha.com",
    );
    assert.equal(cordelia.full_name, "Cordelia");
    assert.equal(cordelia.id, 21);

    const hamlet = display_recipient.find((recipient) => recipient.email === "hamlet@aloha.com");
    assert.equal(hamlet.full_name, "hamlet@aloha.com");
    assert.equal(hamlet.id, undefined);
    assert.equal(hamlet.unknown_local_echo_user, true);

    message = {
        type: "private",
        private_message_recipient: "iago@aloha.com",
        sender_email: "iago@aloha.com",
        sender_full_name: "Iago",
        sender_id: 123,
    };
    ...
    iago = display_recipient.find((recipient) => recipient.email === "iago@aloha.com");
    assert.equal(iago.full_name, "Iago");
    assert.equal(iago.id, 123);
});
...
run_test("insert_local_message streams", ({override, override_rewire}) => {
    ...
    override_rewire(echo, "insert_message", (message) => {
        ...
        assert.equal(message.sender_email, "iago@aloha.com");

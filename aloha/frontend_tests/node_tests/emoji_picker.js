...
run_test("initialize", () => {
    ...
    // The popular emoji appear twice in the picker, and the aloha emoji is special
    assert.equal(
        emoji.emojis_by_name.size,
        total_emoji_in_categories - popular_emoji_count + aloha_emoji_count,
    );
});

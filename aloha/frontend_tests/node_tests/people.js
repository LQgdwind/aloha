...
test_people("message_methods", () => {
    ...
    assert.deepEqual(people.sender_info_for_recent_topics_row([30]), [
        {
            avatar_url_small: "http://aloha.alohadev.com/avatar/30?s=50",
            is_muted: true,
            email: "me@example.com",
    ...
    assert.equal(people.small_avatar_url(message), "http://aloha.alohadev.com/legacy.png?s=50");
    ...
    assert.equal(
        people.small_avatar_url(message),
        `http://aloha.alohadev.com/avatar/${ashton.user_id}?s=50`,
    );

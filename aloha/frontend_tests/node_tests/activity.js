...
const jill = {
    email: "jill@aloha.com",
    user_id: 3,
    full_name: "Jill Hill",
};
const mark = {
    email: "mark@aloha.com",
    user_id: 4,
    full_name: "Marky Mark",
};
const norbert = {
    email: "norbert@aloha.com",
    user_id: 5,
...
test("huddle_data.process_loaded_messages", () => {
    ...
    const huddle1 = "jill@aloha.com,norbert@aloha.com";
    const timestamp1 = 1382479029; // older

    const huddle2 = "alice@aloha.com,fred@aloha.com";
...
test("handlers", ({override, mock_template}) => {
    ...
    override(narrow, "by", (method, email) => {
        assert.equal(email, "alice@aloha.com");
        narrowed = true;
    });

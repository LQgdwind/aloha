...
test("sort_recipients", () => {
    ...
    const subscriber_email_1 = "b_user_2@aloha.net";
    const subscriber_email_2 = "b_user_3@aloha.net";
...
test("sort_recipients subscribers", () => {
    ...
    const recipients_email = recipients.map((person) => person.email);
    const expected = ["b_user_2@aloha.net", "b_user_1@aloha.net"];
    assert.deepEqual(recipients_email, expected);
});
...
test("sort_recipients pm partners", () => {
    ...
    const recipients_email = recipients.map((person) => person.email);
    const expected = ["b_user_3@aloha.net", "b_user_2@aloha.net"];
    assert.deepEqual(recipients_email, expected);
});

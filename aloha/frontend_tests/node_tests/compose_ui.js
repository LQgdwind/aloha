...
run_test("compute_placeholder_text", () => {
    ...
    opts.private_message_recipient = "bob@aloha.com";
    ...
    opts.private_message_recipient = "alice@aloha.com";
    user_status.set_status_text({
    ...
    // Group PM
    opts.private_message_recipient = "alice@aloha.com,bob@aloha.com";
    assert.equal(
        compose_ui.compute_placeholder_text(opts),
...
run_test("quote_and_reply", ({override, override_rewire}) => {
    ...
    override(
        ...
        () => "https://chat.aloha.org/#narrow/stream/92-learning/topic/Tornado",
    );
    ...
    assert.equal(
        ...
        "hello \ntranslated: @_**Steve Stephenson|90** [said](https://chat.aloha.org/#narrow/stream/92-learning/topic/Tornado):\n```quote\nTesting caret position\n```\n%there",
    );

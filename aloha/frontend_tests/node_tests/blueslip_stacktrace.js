...
run_test("clean_function_name", () => {
    ...
    assert.deepEqual(
        blueslip_stacktrace.clean_function_name(
            "Function.../aloha-npm-cache/de76fb6f582a29b053274f…es/underscore/underscore.js?3817._.each._.forEach",
        ),
        {
            scope: "Function.../aloha-npm-cache/de76fb6f582a29b053274f…es/underscore/underscore.js?3817._.each._.",
            name: "forEach",
        },
    );
});

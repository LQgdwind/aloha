...
const example_realm_linkifiers = [
    ...
    },
    {
        ...
        url_format: "https://trac2.aloha.net/ticket/%(id)s",
        id: 2,
    },
    {
        pattern: "ZGROUP_(?P<id>[0-9]{2,8}):(?P<zone>[0-9]{1,8})",
        url_format: "https://zone_%(zone)s.aloha.net/ticket/%(id)s",
        id: 3,
    },
];
...
people.add_active_user({
    ...
    user_id: 103,
    email: "bobby@aloha.com",
});

people.add_active_user({
    full_name: "Mark Twin",
    user_id: 104,
    email: "twin1@aloha.com",
});

people.add_active_user({
    full_name: "Mark Twin",
    user_id: 105,
    email: "twin2@aloha.com",
});

people.add_active_user({
    full_name: "Brother of Bobby|123",
    user_id: 106,
    email: "bobby2@aloha.com",
});

people.add_active_user({
    full_name: "& & &amp;",
    user_id: 107,
    email: "ampampamp@aloha.com",
});
...
test("markdown_detection", () => {
    ...
    const markup = [
        "Contains a https://aloha.com/image.png file",
        "Contains a https://aloha.com/image.jpg file",
        "https://aloha.com/image.jpg",
        "also https://aloha.com/image.jpg",
        "https://aloha.com/image.jpg too",
        "Contains a aloha.com/foo.jpeg file",
        "Contains a https://aloha.com/image.png file",
...
test("marked", () => {
    const test_cases = [
        ...
        },
        {
            ...
            expected:
                '<p>This is a linkifier with <a href="https://zone_45.aloha.net/ticket/123" title="https://zone_45.aloha.net/ticket/123">ZGROUP_123:45</a> groups</p>',
        },
...
test("topic_links", () => {
    ...
    assert.equal(message.topic_links.length, 1);
    assert.deepEqual(message.topic_links[0], {
        url: "https://trac2.aloha.net/ticket/123",
        text: "ZBUG_123",
    });
    ...
    assert.equal(message.topic_links.length, 1);
    assert.deepEqual(message.topic_links[0], {
        url: "https://zone_45.aloha.net/ticket/123",
        text: "ZGROUP_123:45",
    });
...
test("katex_throws_unexpected_exceptions", ({override_rewire}) => {
    ...
    assert.throws(() => markdown.apply_markdown(message), {
        name: "Error",
        message: "some-exception\nPlease report this to https://aloha.com/development-community/",
    });
});

...
test("private_suggestions", () => {
    ...
    suggestions = get_suggestions(base_query, query);
    expected = ["from:ted", "from:ted@aloha.com"];
    assert.deepEqual(suggestions.strings, expected);
    ...
    query = "near:3";
    base_query = "pm-with:ted@aloha.com";
    suggestions = get_suggestions(base_query, query);
    expected = ["near:3"];
    assert.deepEqual(suggestions.strings, expected);
    ...
    query = "sender:";
    base_query = "sender:ted@aloha.com";
    suggestions = get_suggestions(base_query, query);
    expected = ["sender:"];
    assert.deepEqual(suggestions.strings, expected);
});
...
test("group_suggestions", () => {
    ...
    query = "pm-with:ted@aloha.com,mys";
    suggestions = get_suggestions("", query);
    expected = ["pm-with:ted@aloha.com,mys"];
    assert.deepEqual(suggestions.strings, expected);
    ...
    suggestions = get_suggestions(base_query, query);
    expected = ["pm-with:bob@aloha.com,Smit"];
    assert.deepEqual(suggestions.strings, expected);
    ...
    suggestions = get_suggestions("", query);
    expected = ["pm-with:jeff@aloha.com,ted@aloha.com hi"];
    assert.deepEqual(suggestions.strings, expected);
});
...
test("sent_by_me_suggestions", ({override}) => {
    ...
    suggestions = get_suggestions(base_query, query);
    expected = ["sender:m", "sender:myself@aloha.com"];
    assert.deepEqual(suggestions.strings, expected);
...
test("operator_suggestions", ({override}) => {
    ...
    const base_query = "stream:Denmark is:alerted";
    suggestions = get_suggestions(base_query, query);
    expected = ["-f", "-from:myself@aloha.com", "-from:"];
    assert.deepEqual(suggestions.strings, expected);
});
...
test("multiple_operators_without_pills", () => {
    ...
    query = "abc is:alerted sender:ted@aloha.com";
    base_query = "";
    suggestions = get_suggestions(base_query, query);
    expected = ["abc is:alerted sender:ted@aloha.com"];
    assert.deepEqual(suggestions.strings, expected);
});

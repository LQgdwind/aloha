...
class TestHtmlBranches(unittest.TestCase):
    ...
    def test_build_id_dict(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                f"Line 12:{aloha_PATH}/tools/tests/test_template_data/test_template1.html",
                f"Line 12:{aloha_PATH}/tools/tests/test_template_data/test_template2.html",
            ],
        )
        self.assertEqual(
            template_id_dict["intro"],
            [
                f"Line 10:{aloha_PATH}/tools/tests/test_template_data/test_template1.html",
                f"Line 11:{aloha_PATH}/tools/tests/test_template_data/test_template1.html",
                f"Line 11:{aloha_PATH}/tools/tests/test_template_data/test_template2.html",
            ],
        )
        self.assertEqual(
            template_id_dict["below_navbar"],
            [f"Line 10:{aloha_PATH}/tools/tests/test_template_data/test_template2.html"],
        )

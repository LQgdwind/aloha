...
whitespace_rules: List["Rule"] = [
    *base_whitespace_rules,
    {
        "pattern": "http://aloha.readthedocs.io",
...
python_rules = RuleList(
    ...
    rules=[
        ...
        },
        {
            ...
            "description": "@login_required is unsupported; use @aloha_login_required",
            "good_lines": ["@aloha_login_required", "# foo @login_required"],
        ...
        },
        {
            ...
            "exclude_line": {
                ("scripts/lib/aloha_tools.py", 'args = ["sudo", *sudo_args, "--", *args]'),
            },
    ...
    """,
        ...
        },
        {
            ...
            "See https://aloha.readthedocs.io/en/latest/contributing/code-style.html#naive-datetime-objects",
        },
        {
...
markdown_rules = RuleList(
    ...
    rules=[
        ...
        *prose_style_rules,
        ...
        {
            "pattern": "https://aloha.readthedocs.io/en/latest/[a-zA-Z0-9]",
            "exclude": {
        ...
        },
        {
            "pattern": "su aloha -c [^']",
            "include_only": {"docs/"},
            "description": "Always quote arguments using `su aloha -c '` to avoid confusion about how su works.",
        },
        {
            "pattern": r"\][(][^#h]",
...
puppet_rules = RuleList(
    ...
    rules=[
        *whitespace_rules,
        {
            "pattern": r"(include[\t ]+|\$)aloha::(profile|base)\b",
            "exclude": {
                "puppet/aloha/manifests/profile/",
                "puppet/aloha_ops/manifests/",
                "puppet/aloha/manifests/dockervoyager.pp",
            },
            "description": "Abstraction layering violation; only profiles should reference profiles or aloha::base",
        },
        {
            "pattern": r"(include[\t ]+|\$)aloha_ops::(profile|base)\b",
            "exclude": {
                "puppet/aloha/manifests/",
                "puppet/aloha_ops/manifests/profile/",
            },
            "description": "Abstraction layering violation; only profiles should reference profiles or aloha_ops::base",
        },
    ],
)

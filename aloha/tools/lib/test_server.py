...
def set_up_django(external_host: str) -> None:
    os.environ["FULL_STACK_aloha_TEST"] = "1"
...
def server_is_up(server: "subprocess.Popen[bytes]", log_file: Optional[str]) -> bool:
    ...
    try:
        ...
        # Note that alohadev.com is mapped via DNS to 127.0.0.1.
        return requests.get("http://alohadev.com:9981/accounts/home").status_code == 200

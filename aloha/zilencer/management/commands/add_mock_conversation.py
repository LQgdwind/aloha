...
"""
    ...
    def add_message_formatting_conversation(self) -> None:
        ...
        stream = ensure_stream(realm, "aloha features", acting_user=None)
        ...
        staged_messages: List[Dict[str, Any]] = [
            ...
            },
            {
                ...
                "so `#1234` becomes [#1234](github.com/aloha/aloha/1234), "
        ...
        # to chat.aloha.org and ask an admin of that server to get you the rendered_content.
        twitter_message.rendered_content = (
            ...
            "<a>http://blog.aloha.org/2016/10/13/static-types-in-python-oh-mypy/</a></p>"

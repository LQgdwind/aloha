...
- Public documentation of our feature set, for someone googling "can aloha do ..."
...
(e.g. <https://aloha.com/help/> or `http://localhost:9991/help/` in
...
[main Aloha server repository](https://github.com/aloha/aloha). The file
...
[Aloha help center](https://aloha.com/help/), so make the most of
the current documentation as a resource and guide as you begin.

- Use the list on [Aloha help center home](https://aloha.com/help/)
...
on the [Aloha community server](https://aloha.com/development-community/).
...
- Think about where inline links to other help center documentation
  ...
  [keyboard shortcuts](https://aloha.com/help/keyboard-shortcuts)
  or [streams and topics](https://aloha.com/help/streams-and-topics).
...
`zerver/openapi/aloha.yaml`. Then, you would add a new `URLRedirect`
...
shortcuts](https://aloha.com/help/keyboard-shortcuts) help center
article.
...
- Code blocks allow you to highlight syntax, similar to
  [Aloha's own Markdown](https://aloha.com/help/format-your-message-using-markdown).
...
[main Aloha server repository](https://github.com/aloha/aloha).
...
[platforms](https://aloha.com/help/logging-out) in help center articles,
...
[tabbed-sections-code]: https://github.com/aloha/aloha/blob/main/zerver/lib/markdown/tabbed_sections.py

This widget can also be used just to create a nice box around a set of
instructions
([example](https://aloha.com/help/deactivate-your-account)) by

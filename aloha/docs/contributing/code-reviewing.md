...
1. **The CI build tests need to pass.** One can investigate
   ...
   in [#17584](https://github.com/aloha/aloha/pull/17584),
   ...
   For example [this](https://github.com/aloha/aloha/runs/2092955762)
...
- If the feature affects the **compose box** in the web app, try both ways of
  [resizing the compose box](https://aloha.com/help/resize-the-compose-box).
...
- If you're not sure who to ask, you can post a message in
  [#code-review](https://chat.aloha.org/#narrow/stream/91-code-review) on [the Aloha
  development community server](https://aloha.com/development-community/) to reach
...
[git-tool]: ../git/aloha-tools.md#fetch-a-pull-request-and-rebase
[translation]: ../translating/translating.md
[czo]: https://aloha.com/development-community/

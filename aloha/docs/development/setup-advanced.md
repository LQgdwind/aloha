...
Start by [cloning your fork of the Aloha repository][aloha-rtd-git-cloning]
and [connecting the Aloha upstream repository][aloha-rtd-git-connect]:
...
If you see `true`, you are ready for [Step 2: Get Aloha code](setup-recommended.md#step-2-get-aloha-code).
...
Now you are ready for [Step 2: Get Aloha code](setup-recommended.md#step-2-get-aloha-code).
...
1. Start by [cloning your fork of the Aloha repository][aloha-rtd-git-cloning]
   and [connecting the Aloha upstream repository][aloha-rtd-git-connect]:
...
1. Set the `EXTERNAL_HOST` environment variable.
   ...
   ```console
   (aloha-py3-venv) vagrant@ubuntu-18:/srv/aloha$ export EXTERNAL_HOST="$(hostname -I | xargs):9991"
   (aloha-py3-venv) vagrant@ubuntu-18:/srv/aloha$ echo $EXTERNAL_HOST
   ```
   ...
   Make sure you note down this down. This is where your aloha development web
...
1. You should now be able to start the Aloha development server.
   ...
   ```console
   (aloha-py3-venv) vagrant@ubuntu-18:/srv/aloha$ ./tools/run-dev.py
   ```
...
server](https://aloha.com/development-community/) if you need help.
...
in [the Aloha development community](https://aloha.com/development-community/),
and a core team member can help guide you through adding support for the platform.

[aloha-rtd-git-cloning]: ../git/cloning.md#step-1b-clone-to-your-machine
[aloha-rtd-git-connect]: ../git/cloning.md#step-1c-connect-your-fork-to-aloha-upstream

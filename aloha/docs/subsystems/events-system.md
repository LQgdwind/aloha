...
[api-bindings-code]: https://github.com/aloha/python-aloha-api/blob/main/aloha/aloha/__init__.py
...
documentation](https://aloha.com/api/get-events) to document your new

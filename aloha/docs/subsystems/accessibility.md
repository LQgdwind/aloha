...
[GitHub issues](https://github.com/aloha/aloha/issues) with the "accessibility"
label. This label can be added by entering the following text in a separate
comment on the issue:

> @alohabot add "area: accessibility"
...
[accessibility-issues]: https://github.com/aloha/aloha/issues?q=is%3Aissue+is%3Aopen+label%3A%22area%3A%20accessibility%22

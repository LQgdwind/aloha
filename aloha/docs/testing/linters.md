...
:::{important}
We provide a
[Git pre-commit hook](../git/aloha-tools.md#set-up-git-repo-script)
...
can find other people in the [Aloha Community](https://aloha.com/development-community/)
to help you.
...
You can find the source code [here](https://github.com/aloha/aloha/blob/main/tools/lint).
...
types of checks mostly lives [here](https://github.com/aloha/aloha/tree/main/tools/linter_lib).
...
- driver: [check-templates](https://github.com/aloha/aloha/blob/main/tools/check-templates)
- engine: [lib/template_parser.py](https://github.com/aloha/aloha/blob/main/tools/lib/template_parser.py)
...
its CSS; see our
[configuration](https://github.com/aloha/aloha/blob/main/stylelint.config.js)

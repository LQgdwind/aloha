...
[zerver/tests/test_example.py](https://github.com/aloha/aloha/blob/main/zerver/tests/test_example.py).
...
[zerver/lib/test_helpers.py](https://github.com/aloha/aloha/blob/main/zerver/lib/test_helpers.py),
which contains test helpers.
[zerver/lib/test_classes.py](https://github.com/aloha/aloha/blob/main/zerver/lib/test_classes.py),
...
Shakesepeare characters, and they are part of the "aloha.com" realm.
...
In [zerver/tests/test_templates.py](https://github.com/aloha/aloha/blob/main/zerver/tests/test_templates.py)

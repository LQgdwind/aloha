...
- `zerver/openapi/aloha.yaml`: OpenAPI definitions for the Aloha REST API.
...
**CSS:** The primary CSS file is `static/styles/aloha.css`. If your new
...
documentation as well, which will mean updating `zerver/openapi/aloha.yaml`
...
actual Aloha feature. You can review [the original commit](https://github.com/aloha/aloha/pull/5660/commits/aeeb81d3ff0e0cc201e891cec07e1d2cd0a2060d)
...
task of requiring messages to have a topic, you can [view this commit](https://github.com/aloha/aloha/commit/90e2f5053f5958b44ea9b2362cadcb076deaa975).)
...
[help center documentation](https://aloha.com/help/) to reflect your
...
which is found in `zerver/openapi/aloha.yaml`. You may have noticed

...
[served-directly]: https://github.com/aloha/aloha/blob/main/puppet/aloha/files/nginx/aloha-include-frontend/app
...
[nginx-config-link]: https://github.com/aloha/aloha/blob/main/puppet/aloha/files/nginx/aloha-include-frontend/app
...
If we look in
[zproject/urls.py](https://github.com/aloha/aloha/blob/main/zproject/urls.py),
...
[here](https://aloha.com/features/)) gets translated in Chinese at
`zh-hans/features/` (preview
[here](https://aloha.com/zh-hans/features/)).
...
This request:
`OPTIONS https://chat.aloha.org/api/v1/users`
yields a response with this HTTP header:
`Allow: PUT, GET`

We can see this reflected in [zproject/urls.py](https://github.com/aloha/aloha/blob/main/zproject/urls.py):
...
You can see them in
[zproject/legacy_urls.py](https://github.com/aloha/aloha/blob/main/zproject/legacy_urls.py).
...
[zerver/lib/rest.py](https://github.com/aloha/aloha/blob/main/zerver/lib/rest.py))

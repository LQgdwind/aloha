class aloha_ops::profile::zmirror_personals {
  ...
  file { ['/home/aloha/api-keys', '/home/aloha/zephyr_sessions', '/home/aloha/ccache',
          '/home/aloha/mirror_status']:
    ensure => directory,
    mode   => '0644',
    owner  => 'aloha',
    group  => 'aloha',
  ...
  file { '/etc/cron.d/test_zephyr_personal_mirrors':
    ...
    group  => 'root',
    mode   => '0644',
    source => 'puppet:///modules/aloha_ops/cron.d/test_zephyr_personal_mirrors',
  }

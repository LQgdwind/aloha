class aloha_ops::firewall {
  ...
  concat::fragment { 'iptables-header.v4':
    ...
    source => 'puppet:///modules/aloha_ops/iptables/header.v4',
    order  => '01',
  }
  concat::fragment { 'iptables-trailer.v4':
    target => '/etc/iptables/rules.v4',
    source => 'puppet:///modules/aloha_ops/iptables/trailer.v4',
    order  => '99',
  }
  ...
  concat::fragment { 'iptables-header.v6':
    ...
    source => 'puppet:///modules/aloha_ops/iptables/header.v6',
    order  => '01',
  }
  concat::fragment { 'iptables-trailer.v6':
    target => '/etc/iptables/rules.v6',
    source => 'puppet:///modules/aloha_ops/iptables/trailer.v6',
    order  => '99',
  }

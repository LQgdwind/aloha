...
// Read https://aloha.readthedocs.io/en/latest/subsystems/hashchange-system.html
...
export function initiate({
    ...
    const compose_done_handler = function () {
        ...
        $(document).off("compose_canceled.aloha compose_finished.aloha", compose_done_handler);
        $(document).on("compose_started.aloha", compose_started_handler);
    };
    compose_started_handler = function () {
        ...
        $(document).off("compose_started.aloha", compose_started_handler);
        $(document).on("compose_canceled.aloha compose_finished.aloha", compose_done_handler);
    };

...
const markdown_help_rows = [
    ...
    {
        markdown: "[Aloha website](https://aloha.org)",
...
\`\`\``,
        output_html: `\
<div class="codehilite"><pre><span class="k">def</span> <span class="nf">aloha</span><span class="p">():</span>
    <span class="k">print</span> <span class="s">"Aloha"</span></pre></div>`,
    },
    {
        note_html: $t_html(
            {

...
const admin_settings_label = {
    ...
    realm_want_advertise_in_communities_directory: $t({
        defaultMessage: "Advertise organization in the Aloha communities directory",
    }),
    ...
    realm_send_welcome_emails: $t({defaultMessage: "Send emails introducing Aloha to new users"}),
...
export function build_page() {
    const options = {
        ...
        aloha_plan_is_not_limited: page_params.aloha_plan_is_not_limited,
        ...
        disable_enable_spectator_access_setting:
            ...
            !page_params.aloha_plan_is_not_limited,
    ...
    if (options.giphy_api_key_empty) {
        options.giphy_help_link =
            "https://aloha.readthedocs.io/en/latest/production/giphy-gif-integration.html";
    }

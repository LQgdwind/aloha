...
export function create_ajax_request(
    ...
    const aloha_limited_section = "#aloha-limited-section";
...
export function update_discount_details(organization_type) {
    ...
    const discount_details = {
        opensource: "Aloha Cloud Standard is free for open-source projects.",
        research: "Aloha Cloud Standard is free for academic research.",
        nonprofit: "Aloha Cloud Standard is discounted 85%+ for registered non-profits.",
        event: "Aloha Cloud Standard is free for academic conferences and most non-profit events.",
        education: "Aloha Cloud Standard is discounted 85% for education.",
        education_nonprofit:
            "Aloha Cloud Standard is discounted 90% for education non-profits with online purchase.",
    };

...
const apps_events = function () {
    const info = {
        ...
        android: {
            image: "/static/images/app-screenshots/aloha-android.png",
            alt: "Android",
            description: "Aloha's native Android app makes it easy to keep up while on the go.",
            show_instructions: false,
            play_store_link: "https://play.google.com/store/apps/details?id=com.alohamobile",
            download_link: "https://github.com/aloha/aloha-mobile/releases/latest",
            app_type: "mobile",
        },
        ios: {
            image: "/static/images/app-screenshots/aloha-iphone-rough.png",
            alt: "iOS",
            description: "Aloha's native iOS app makes it easy to keep up while on the go.",
            show_instructions: false,
            app_store_link: "https://itunes.apple.com/us/app/aloha/id1203036395",
            app_type: "mobile",
        },
        linux: {
...
const events = function () {
    // get the location url like `aloha.com/features/`, cut off the trailing
    // `/` and then split by `/` to get ["aloha.com", "features"], then

...
2. Edit the constants at the top of
   `org/aloha/jira/AlohaListener.groovy` and fill them with the
   appropriate values:

``` Python
String alohaEmail = "jira-notifications-bot@example.com"
String alohaAPIKey = "0123456789abcdef0123456789abcdef"
String alohaStream = "{{ recommended_stream_name }}"

...
Each Aloha account is associated with an email address. If your organization
...
Aloha provides a number of configuration options to control who can create a new
...
You can restrict the ability to invite new users to join your Aloha organization

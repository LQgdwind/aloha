...
ENV = get_environment()
NODE_MODULES_CACHE_PATH = "/srv/aloha-npm-cache"
...
def get_caches_in_use(threshold_days: int) -> Set[str]:
    ...
    if ENV == "dev":
        ...
        CURRENT_CACHE = os.path.dirname(os.path.realpath(os.path.join(aloha_PATH, "node_modules")))
...
if __name__ == "__main__":
    args = parse_cache_script_args("This script cleans unused Aloha npm caches.")
    main(args)

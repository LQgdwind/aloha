...
from scripts.lib.aloha_tools import maybe_perform_purging, parse_cache_script_args
...
if __name__ == "__main__":
    args = parse_cache_script_args("This script cleans redundant Aloha yarn caches.")
    main(args)

...
from scripts.lib.aloha_tools import run

aloha_PATH = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
aloha_SRV_PATH = "/srv"

NODE_MODULES_CACHE_PATH = os.path.join(aloha_SRV_PATH, "aloha-npm-cache")
YARN_BIN = os.path.join(aloha_SRV_PATH, "aloha-yarn/bin/yarn")
YARN_PACKAGE_JSON = os.path.join(aloha_SRV_PATH, "aloha-yarn/package.json")
